...
#         super(ChannelBitcoin, self).__init__(switchboard=switchboard, name=self.CHANNEL)
...
#             log.error("Could not retrieve bitcoin balance: {error}".format(error=e))
#             return

#         if current_balance > bitcoin_account["balance"]:
#             canarydrop = Canarydrop(
#                 **get_canarydrop(canarytoken=bitcoin_account["canarytoken"])
#             )
#             self.dispatch(
#                 canarydrop=canarydrop,
...
#             )
#         if (
#             "new_balance" in kwargs
#             and kwargs["new_balance"]
#             and "old_balance" in kwargs
#             and kwargs["old_balance"]
#         ):
#             additional_report += (
#                 "Balance Changed: from {old_balance} to {new_balance}\r\n".format(
